...
# ---------------------------------------------------------------------------
# AppConfig test factory
# ---------------------------------------------------------------------------

# Minimal valid config data satisfying all Pydantic constraints.
# Used as base for create_test_app_config() — override individual keys as needed.
_MINIMAL_CONFIG_DATA: dict[str, Any] = {
...
def create_test_app_config(**overrides: Any) -> Any:
    """Create a minimal valid AppConfig for testing.

    Lazy-imports AppConfig to avoid import errors during collection.
    Supports nested key overrides via top-level dict merge.

    Args:
        **overrides: Top-level fields to override in the config data.

    Returns:
        AppConfig instance with test defaults and applied overrides.

    """
    from core.models.track_models import AppConfig

    data = {**_MINIMAL_CONFIG_DATA, **overrides}
