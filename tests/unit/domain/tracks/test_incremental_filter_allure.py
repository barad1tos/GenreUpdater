...
class TestIncrementalFilterServiceAllure:
    ...
    @patch("src.domain.tracks.incremental_filter.get_full_log_path")
    @patch("src.domain.tracks.incremental_filter.load_track_list")
    @patch("src.domain.tracks.incremental_filter.compute_track_delta")
