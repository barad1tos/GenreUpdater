...
class TestGenreManagerAllure:
    ...
    async def test_update_genres_by_artist_async_e2e(self) -> None:
        ...
        with (
            ...
            patch("src.domain.tracks.genre_manager.group_tracks_by_artist") as mock_group,
            patch("src.domain.tracks.genre_manager.determine_dominant_genre_for_artist") as mock_determine,
        ):
