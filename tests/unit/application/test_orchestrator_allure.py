...
class TestOrchestratorAllure:
    ...
    async def test_music_app_not_running(self) -> None:
        ...
        with allure.step("Mock Music app as not running"), patch("src.application.orchestrator.is_music_app_running", return_value=False):
    ...
    async def test_dry_run_context(self, dry_run: bool, test_mode: bool, expected_mode: str) -> None:
        ...
        with allure.step("Run command with dry-run/test mode"), patch("src.application.orchestrator.is_music_app_running", return_value=True):
            await orchestrator.run_command(args)
    ...
    async def test_clean_artist_command(self) -> None:
        ...
        with allure.step("Execute clean artist command"), patch("src.application.orchestrator.is_music_app_running", return_value=True):
            await orchestrator.run_command(args)
    ...
    async def test_update_years_command(self) -> None:
        ...
        with allure.step("Execute update years command"), patch("src.application.orchestrator.is_music_app_running", return_value=True):
            await orchestrator.run_command(args)
    ...
    async def test_revert_years_command(self) -> None:
        ...
        with allure.step("Execute revert years command"), patch("src.application.orchestrator.is_music_app_running", return_value=True):
            await orchestrator.run_command(args)
    ...
    async def test_verify_database_command(self) -> None:
        ...
        with allure.step("Execute verify database command"), patch("src.application.orchestrator.is_music_app_running", return_value=True):
            await orchestrator.run_command(args)
    ...
    async def test_main_pipeline_default(self) -> None:
        ...
        with allure.step("Execute default command"), patch("src.application.orchestrator.is_music_app_running", return_value=True):
            await orchestrator.run_command(args)
    ...
    async def test_batch_command(self) -> None:
        ...
        with (
            ...
            patch("src.application.orchestrator.is_music_app_running", return_value=True),
            patch("src.application.orchestrator.BatchProcessor") as mock_batch_processor_class,
        ):
    ...
    def test_rotate_keys_command(self) -> None:
        ...
        with (
            ...
            patch("src.application.orchestrator.SecureConfig", return_value=mock_secure_config),
    ...
    def test_rotate_keys_error_handling(self) -> None:
        ...
        with (
            ...
            patch("src.application.orchestrator.SecureConfig") as mock_secure_config_class,
            patch("pathlib.Path.exists", return_value=True),
    ...
    async def test_test_mode_execution(self) -> None:
        ...
        with allure.step("Execute in test mode"), patch("src.application.orchestrator.is_music_app_running", return_value=True):
            await orchestrator.run_command(args)
    ...
    async def test_test_artists_from_config(self) -> None:
        ...
        with allure.step("Execute command"), patch("src.application.orchestrator.is_music_app_running", return_value=True):
            await orchestrator.run_command(args)
