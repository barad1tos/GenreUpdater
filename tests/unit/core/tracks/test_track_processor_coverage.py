...
class TestProcessTestArtists:
    ...
    @pytest.mark.asyncio
    async def test_uses_dry_run_test_artists(
    ...
    @pytest.mark.asyncio
    async def test_uses_config_test_artists(
        self, processor: TrackProcessor, mock_ap_client: AsyncMock
    ) -> None:
    ...
    @pytest.mark.asyncio
    async def test_returns_empty_when_no_test_artists(
...
class TestApplyArtistRenames:
    ...
    @pytest.mark.asyncio
    async def test_skips_when_no_renamer(
        self, processor: TrackProcessor, sample_track: TrackDict
    ) -> None:
    ...
    @pytest.mark.asyncio
    async def test_handles_renamer_exception(
        self, processor: TrackProcessor, sample_track: TrackDict
    ) -> None:
...
class TestTryFetchTestTracks:
    ...
    @pytest.mark.asyncio
    async def test_returns_none_when_artist_specified(
        self, processor: TrackProcessor
    ) -> None:
    ...
    @pytest.mark.asyncio
    async def test_returns_none_when_ignore_test_filter(
        self, processor: TrackProcessor
    ) -> None:
    ...
    @pytest.mark.asyncio
    async def test_returns_none_when_no_test_artists(
        self, processor: TrackProcessor
    ) -> None:
    ...
    @pytest.mark.asyncio
    async def test_returns_empty_when_test_artists_configured_but_no_tracks(
        self, processor: TrackProcessor, mock_ap_client: AsyncMock
    ) -> None:
...
class TestTryFetchSnapshotTracks:
    ...
    @pytest.mark.asyncio
    async def test_returns_none_when_snapshot_disabled(
        self, processor: TrackProcessor
    ) -> None:
    ...
    @pytest.mark.asyncio
    async def test_returns_none_when_force_refresh(
        self, processor: TrackProcessor
    ) -> None:
...
class TestUpdateSnapshot:
    ...
    @pytest.mark.asyncio
    async def test_delegates_to_cache_manager(
        self, processor: TrackProcessor, sample_track: TrackDict
    ) -> None:
...
class TestValidateTracksSecurity:
    ...
    def test_filters_invalid_tracks(
        self, processor: TrackProcessor
    ) -> None:
...
class TestFetchTracksFromApplescript:
    ...
    @pytest.mark.asyncio
    async def test_handles_error_prefix(
        self, processor: TrackProcessor, mock_ap_client: AsyncMock
    ) -> None:
    ...
    @pytest.mark.asyncio
    async def test_handles_no_tracks_found(
        self, processor: TrackProcessor, mock_ap_client: AsyncMock
    ) -> None:
...
class TestFetchTracksByIds:
    ...
    @pytest.mark.asyncio
    async def test_returns_empty_for_empty_ids(
        self, processor: TrackProcessor
    ) -> None:
    ...
    @pytest.mark.asyncio
    async def test_fetches_tracks_by_ids(
        self, processor: TrackProcessor, mock_ap_client: AsyncMock
    ) -> None:
    ...
    @pytest.mark.asyncio
    async def test_handles_empty_batch_response(
        self, processor: TrackProcessor, mock_ap_client: AsyncMock
    ) -> None:
    ...
    @pytest.mark.asyncio
    async def test_processes_batches(
        self, processor: TrackProcessor, mock_ap_client: AsyncMock
    ) -> None:
...
class TestFetchTracksAsync:
    ...
    @pytest.mark.asyncio
    async def test_returns_dry_run_test_tracks(
        self, processor: TrackProcessor, sample_track: TrackDict
    ) -> None:
...
class TestUpdateArtistAsync:
    ...
    @pytest.mark.asyncio
    async def test_delegates_to_update_executor(
        self, processor: TrackProcessor, sample_track: TrackDict
    ) -> None:
