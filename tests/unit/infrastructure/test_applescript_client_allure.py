...
Track 3|Artist 3|Album 3|2022|Pop"""
    ...
    async def test_rate_limiter_validation(self) -> None:
        ...
        from src.infrastructure.applescript_client import EnhancedRateLimiter
        ...
        with allure.step("Test invalid window_size"):
        ...
        with allure.step("Test invalid max_concurrent"):
