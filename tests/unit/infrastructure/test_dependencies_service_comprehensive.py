...
from src.infrastructure.dependencies_service import (
    DependencyContainer,
...
class TestDependencyContainer:
    ...
    def test_initialize_apple_script_client_dry_run(
        ...
        with (
            ...
            patch("src.infrastructure.dependencies_service.AppleScriptClient") as mock_client,
            patch("src.infrastructure.dependencies_service.DryRunAppleScriptClient"),
        ):
    ...
    def test_load_config(
        ...
        with patch(
            "src.infrastructure.dependencies_service.load_config",
    ...
    async def test_concurrent_initialization(
        ...
        with (
            patch.object(container, "_load_config", return_value=mock_config),
            patch("src.infrastructure.dependencies_service.Analytics"),
            patch("src.infrastructure.dependencies_service.CacheOrchestrator"),
            patch("src.infrastructure.dependencies_service.PendingVerificationService"),
            patch("src.infrastructure.dependencies_service.create_external_api_orchestrator"),
            patch.object(container, "_initialize_apple_script_client") as mock_init_ap,
