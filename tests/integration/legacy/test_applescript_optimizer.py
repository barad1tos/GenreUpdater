...
from src.services.cache.applescript_optimizer import (
    AppleScriptMetrics,
    AppleScriptOptimizer,
    BatchConfig,
    OptimizationStrategy,
)
from src.services.cache.edge_case_handler import EdgeCaseHandler, EdgeCaseType, EdgeCaseResult, RecoveryStrategy
...
class TestAppleScriptOptimizer(TestCase):
    ...
    def setUp(self) -> None:
        ...
        self.config = BatchConfig(
            ...
            timeout_seconds=10,
            retry_attempts=2,
            strategy=OptimizationStrategy.ADAPTIVE_BATCH
        )
        
        self.optimizer = AppleScriptOptimizer(
            config=self.config,
    ...
    def test_adaptive_batch_optimization(self) -> None:
        ...
        self.optimizer._performance_history = [
            (50, 0.1), (50, 0.09), (50, 0.11), (50, 0.1), (50, 0.08)
        ]
    ...
    def test_parse_batch_result_invalid_data(self) -> None:
        ...
        malformed_result = [
            ...
            None,           # Invalid track
            ["1", "persistent1", "Song 1", "Artist 1", "Album 1", "Rock", "/path1", "invalid_size", 180.5, "2024-01-01", "2024-01-02"],  # Invalid size
        ]
    ...
    def test_batch_config_validation(self) -> None:
        ...
        config = BatchConfig(
            ...
            timeout_seconds=60,
            retry_attempts=5,
            strategy=OptimizationStrategy.CHUNKED_BATCH
        )
