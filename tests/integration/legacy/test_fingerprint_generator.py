...
import pytest
from src.infrastructure.cache.fingerprint_generator import FingerprintGenerationError, FingerprintGenerator
...
class TestFingerprintGenerator:
    ...
    def test_required_properties_validation(self, generator: FingerprintGenerator) -> None:
        ...
        with pytest.raises(FingerprintGenerationError, match="persistent_id cannot be empty"):
            generator.generate_track_fingerprint({"persistent_id": "", "location": "/path/to/song.mp3"})
    ...
    def test_minimal_valid_data(self, generator: FingerprintGenerator) -> None:
        ...
        minimal_data = {"persistent_id": "ABC123", "location": "/path/to/song.mp3"}
    ...
    def test_optional_properties_defaults(self, generator: FingerprintGenerator) -> None:
        ...
        data_without_optionals = {"persistent_id": "ABC123", "location": "/path/to/song.mp3"}
