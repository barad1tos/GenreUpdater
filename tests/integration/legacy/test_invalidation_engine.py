...
from src.services.cache.library_state_manager import ChangeSet
from src.services.cache.invalidation_engine import (
    InvalidationEngine,
    InvalidationTask,
    InvalidationPlan,
    InvalidationError,
...
class TestInvalidationEngine:
    ...
    def sample_changes_mixed(self) -> ChangeSet:
        ...
        return ChangeSet(
            deleted={"track_1", "track_2"},
            added={"track_4", "track_5"},
            modified={"track_3"}
        )
    ...
    def sample_changes_deletions_only(self) -> ChangeSet:
        ...
        return ChangeSet(
            deleted={"track_1", "track_2", "track_3"},
            added=set(),
            modified=set()
        )
    ...
    def test_execute_invalidation_plan_success(self, engine: InvalidationEngine, mock_cache_service: Mock) -> None:
        ...
        task = InvalidationTask(
            cache_key="test_key",
            reason=InvalidationReason.TRACK_DELETED,
            priority=InvalidationPriority.IMMEDIATE,
            track_id="track_1"
        )
    ...
    def test_invalidation_task_post_init(self) -> None:
        ...
        task_with_deps = InvalidationTask(
            "test_key", InvalidationReason.TRACK_DELETED, InvalidationPriority.IMMEDIATE, 
