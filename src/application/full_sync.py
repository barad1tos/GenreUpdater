...
Or from project root:
    python -c "import asyncio; from src.application.full_sync import main; asyncio.run(main())"
"""
...
from src.shared.data.protocols import CacheServiceProtocol
...
from src.application.music_updater import MusicUpdater  # noqa: E402
from src.infrastructure.dependencies_service import DependencyContainer  # noqa: E402
from src.shared.core.logger import get_full_log_path  # noqa: E402
from src.shared.data.metadata import is_music_app_running  # noqa: E402
from src.shared.monitoring.reports import sync_track_list_with_current  # noqa: E402
